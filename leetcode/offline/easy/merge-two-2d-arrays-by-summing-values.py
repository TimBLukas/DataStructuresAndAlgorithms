...
#
# 1. `nums1[i] = [id_i, val_i]` indicate that the number with the id `id_i`
#    has a value equal to `val_i`.
#
# 2. `nums2[i] = [id_i, val_i]` indicate that the number with the id `id_i`
#    has a value equal to `val_i`.
#
...
#
# 2. Each id should be included only once and its value should be the sum of
...
class TestMergeTwo2dArraysBySummingValues(unittest.TestCase):
    def test_example_1(self) -> None:
        self.assertEqual(Solution().mergeArrays(nums1=[[1,2],[2,3],[4,5]], nums2=[[1,4],[3,2],[4,1]]), [[1,6],[2,3],[3,2],[4,6]])

    def test_example_2(self) -> None:
        self.assertEqual(Solution().mergeArrays(nums1=[[2,4],[3,6],[5,5]], nums2=[[1,3],[4,3]]), [[1,3],[2,4],[3,6],[4,3],[5,5]])
