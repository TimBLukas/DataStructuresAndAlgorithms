...
class TestHowManyNumbersAreSmallerThanTheCurrentNumber(unittest.TestCase):
    def test_example_1(self) -> None:
        self.assertEqual(Solution().smallerNumbersThanCurrent(nums=[8,1,2,2,3]), [4,0,1,1,3])

    def test_example_2(self) -> None:
        self.assertEqual(Solution().smallerNumbersThanCurrent(nums=[6,5,4,8]), [2,1,0,3])

    def test_example_3(self) -> None:
        self.assertEqual(Solution().smallerNumbersThanCurrent(nums=[7,7,7,7]), [0,0,0,0])
