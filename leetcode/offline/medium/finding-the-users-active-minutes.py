...
# [ID_i, time_i]` indicates that the user with `ID_i` performed an action at
# the minute `time_i`.
#
...
class TestFindingTheUsersActiveMinutes(unittest.TestCase):
    ...
    def test_example_2(self) -> None:
        self.assertEqual(
            Solution().findingUsersActiveMinutes(logs=[[1, 1], [2, 2], [2, 3]], k=4),
            [1, 1, 0, 0],
        )
